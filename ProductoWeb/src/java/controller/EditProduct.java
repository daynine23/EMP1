...
public class EditProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Producto> listaProducto = productoServices.consultarPorCodigo(codTemp);
        request.setAttribute("codigo", codTemp);
        request.setAttribute("getProductoById", listaProducto);
